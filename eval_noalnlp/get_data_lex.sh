...
wget https://storage.googleapis.com/fact_verification_mithun_files/fever_dev_lex_3labels_26k_no_lists_evidence_not_sents.jsonl  -O data/rte/fever/dev/fever_dev_split_fourlabels.jsonl
