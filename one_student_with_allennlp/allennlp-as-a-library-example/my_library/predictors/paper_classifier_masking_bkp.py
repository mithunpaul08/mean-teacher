...
#             # with open('my_library/predictors/Fever-dev_split_fourlabels.jsonl') as rf\
#             #         , open('23_Mar_Model-FN-13Feb-Data-fever-wrong-predictions.jsonl','w+') as wf:
#             with open('my_library/predictors/Fever-dev-small-test-tokens.jsonl') as rf \
#                     , open('Fever-dev-small-test-tokeninzed.jsonl', 'w+') as wf:
#                 for line in rf:
