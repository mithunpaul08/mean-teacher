...
class Trainer():
    def __init__(self,LOG,device=None):
        self._LOG=LOG
    ...
    def calculate_micro_f1(self,y_pred, y_target,label,accept=False):
        '''
    ...
    def train_1teacher(self, args_in, classifier_teacher_lex, dataset, comet_value_updater, vectorizer,
    ...
    def train_1teacher_1student(self, args_in, classifier_teacher_lex, classifier_student_delex, dataset, comet_value_updater, vectorizer):
    ...
    def train_multiple_teachers_1student(self, args_in, classifier_student_delex_ema, classifier_teacher_lex_ema, classifier_teacher_lex, classifier_student_delex, dataset, comet_value_updater, vectorizer):
